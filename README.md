...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://stg-api.stackbit.com/pull/5ff2d293b99e8d001635a076
...
To start editing your site, you can use the Sanity interface at https://square-basil-2d293.sanity.studio/.
...
Generated at `2021-01-04T08:32:56.531Z` by Stackbit version `0.3.42`.